          ...
          <div class="col">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">The Story Behind Shopy</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="row justify-content-center gutter-1">
          ...
          <div class="col-lg-8">
            <div class="card card-post card-post-lg">
              <img class="card-image" src="https://demo.htmlhunters.com/shopy/assets/images/demo/image-1.jpg" alt="Image">
          ...
          <div class="col-lg-8">
            <div class="bg-white p-4">
              ...
              <div class="bubble">
                <a href="" class="bubble_avatar"><img class="avatar" src="https://demo.htmlhunters.com/shopy/assets/images/demo/user-1.jpg" alt="Avatar"></a>
            ...
            <div class="bg-white p-4">
              ...
              <fieldset class="mb-2">
                <div class="row">
                  <div class="col-12">
                    <div class="form-label-group">
                      <input type="text" id="inputName2" class="form-control form-control-lg" placeholder="Name" required="">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-label-group">
                      <input type="email" id="inputEmail" class="form-control form-control-lg" placeholder="Email" required="">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-label-group">
                      <textarea class="form-control form-control-lg" id="inputComment" rows="3" placeholder="Comment"></textarea>
